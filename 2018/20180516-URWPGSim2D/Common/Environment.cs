...
namespace URWPGSim2D.Common
{
    ...
    public class Field : ICloneable, IDssSerializable
    {
        ...
        /// 偏移量高度（**待求**），单位像素
        /// </summary>
        public int OffsetHeightPix { get; set; }


        /// <summary>
        /// 偏移量宽度（**待求**），单位像素
        /// </summary>
        public int OffsetWidthPix { get; set; }
        #endregion
        ...
        /// </summary>
        [DataMember]
        public int OffsetHeightMm { get; set; }

        /// <summary>
        /// 偏移量宽度，单位毫米
        /// </summary>
        [DataMember]
        public int OffsetWidthMm { get; set; }
        ...
        public void SetField()
        {
            ...
            try
            {
                ...
                OffsetWidthMm = Convert.ToInt32(myConfig.MyXmlReader("OffsetWidthMm"));
                OffsetHeightMm = Convert.ToInt32(myConfig.MyXmlReader("OffsetHeightMm"));
        ...
        public void FieldCalculation()
        {
            ...
            if (dRatioFieldXMmAndZMm <= dRatioPictureBoxWidthAndHeight)
            {
                ...
                OffsetHeightPix = (int)(OffsetHeightMm / ScaleMmToPix + 0.5);
                OffsetWidthPix = (int)(OffsetWidthMm / ScaleMmToPix + 0.5);
            }
            else
            {
        ...
        public Bitmap Draw(Bitmap bmp, bool IsGoalBlockNeeded, int IsFieldInnerLinesNeeded)
        {
            ...
            else if (IsFieldInnerLinesNeeded == 3)
            {
               
                myGraphic.DrawLine(new Pen(Brushes.White, 2),
                    new Point(FieldLengthXPix + FieldInnerBorderPix + FieldOuterBorderPix,
                        (FieldLengthZPix - ForbiddenZoneLengthZPix) / 2 + FieldInnerBorderPix + FieldOuterBorderPix),
                    new Point(FieldLengthXPix + FieldOuterBorderPix + FieldInnerBorderPix - ForbiddenZoneLengthXPix ,
                        (FieldLengthZPix - ForbiddenZoneLengthZPix) / 2 + FieldOuterBorderPix + FieldInnerBorderPix));
                // 画左竖线
                myGraphic.DrawLine(new Pen(Brushes.White, 2),
                    new Point(FieldLengthXPix + FieldOuterBorderPix + FieldInnerBorderPix - ForbiddenZoneLengthXPix ,
            ...
            else if (IsFieldInnerLinesNeeded == 4)
            {


                myGraphic.DrawEllipse(new Pen(Brushes.White, 3),
                           FieldLengthXPix / 2 + FieldInnerBorderPix + FieldOuterBorderPix + OffsetWidthPix - MovingCircleRadiusPix,
                           FieldLengthZPix / 2 + FieldInnerBorderPix + FieldOuterBorderPix - OffsetHeightPix - MovingCircleRadiusPix,
                           MovingCircleRadiusPix * 2, MovingCircleRadiusPix * 2);

                myGraphic.DrawString(Convert.ToString(1), new Font("宋体", MovingCircleRadiusPix * 36 / 20), Brushes.White,
                               FieldLengthXPix / 2 + FieldInnerBorderPix + FieldOuterBorderPix + OffsetWidthPix - MovingCircleRadiusPix + MovingCircleRadiusPix * 22 / 80,
                           FieldLengthZPix / 2 + FieldInnerBorderPix + FieldOuterBorderPix - OffsetHeightPix - MovingCircleRadiusPix + MovingCircleRadiusPix * 15 / 80);
                ...
                myGraphic.DrawString(Convert.ToString(2), new Font("宋体", MovingCircleRadiusPix * 36 / 20), Brushes.White,
                           FieldLengthXPix / 2 + FieldInnerBorderPix + FieldOuterBorderPix + OffsetWidthPix - MovingCircleRadiusPix + MovingCircleRadiusPix * 22 / 80,
                           FieldLengthZPix / 2 + FieldInnerBorderPix + FieldOuterBorderPix + OffsetHeightPix - MovingCircleRadiusPix + MovingCircleRadiusPix * 15 / 80);
