        ...
        public Decision[] GetDecision(Mission mission, int teamId)
        {
           ...
           // FishDecision.FishDecision.MoveToAreaS(mission, ref decisions[0], 0, 0, T2fish4_body, (int)(Math.PI / 2));
            ...
            if (remainTime >= 3000)
            {
                ...
                if (by2 == 0 && by3 == 0 && by4 == 0 && L2 < L1 && L2 < L3)
                {
